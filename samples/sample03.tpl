<html>
  ...
  <h2>flavors</h2>
  <ol>
    {{section:flavors}}<li>flavor: {{flavor}}</li>{{/section:flavors}}
  </ol>
  <h2>mixed</h2>
  <ol>
    {{section:mixed}}<li>color: {{color}}, flavor: {{flavor}} </li>{{/section:mixed}}
  </ol>
  <hr>
  <a href="sample02.php">Previous</a> | <a href="sample04.php">Next</a>
  </body>
</html>